...
model TeacherProfile {
  ...
  // Verification and Payout relationships
...
model LiveSession {
  ...
  maxParticipants Int? // Maximum number of students (null = unlimited)
  ...
  // Session metadata
  sessionNotes  String? // Teacher's notes after session
  studentRating Int? // Student rates teacher (1-5)
  teacherRating Int? // Teacher rates student (1-5)
...
model SessionAvailability {
  ...
  startTime String // "09:00" in 24hr format
  endTime   String // "17:00" in 24hr format

  timezone String @default("UTC")

  isActive Boolean @default(true)

  // Session configuration for this availability slot
  defaultDuration Int @default(60) // Default session duration in minutes
  bufferTime      Int @default(15) // Buffer between sessions in minutes
...
// Verification and Payout Models
model TeacherVerification {
  ...
  identityDocumentType String? // "passport", "driving_license", "national_id"
  identityDocumentUrl  String?
  identityVerifiedAt   DateTime?

  // Qualification verification
  qualificationDocuments   String[] // URLs to qualification documents
  qualificationsVerifiedAt DateTime?

  // Experience verification
  experienceDocuments  String[] // URLs to experience documents
  experienceYears      Int?
...
model PayoutRequest {
  ...
  // Request details
  requestedAmount Decimal // Amount requested in dollars
  ...
  // Processing details
  processedAmount Decimal? // Actual amount processed (after fees)
  processingFee   Decimal? // Processing fee deducted
  netAmount       Decimal? // Final amount sent to teacher

  // External payment tracking
  paymentMethodId String? // Stripe Connect account, PayPal, etc.
...
model PayoutCommission {
  ...
  amount Decimal // Amount included in this payout
...
model EarningsReport {
  ...
  // Metadata
  metadata Json? // Additional data like tax info, etc.
...
enum VerificationLevel {
  Basic // Email + Basic info
  Identity // Government ID verified
  Qualified // Education/Qualification verified
  Professional // Experience + Background check
  Premium // Full verification + enhanced features
}

...
async function main() {
    ...
    for (const course of courses) {
        // Create a dummy user first if needed, but for now assuming we can just create course if userId is optional or we create one.
        // Checking schema... User relation is present. Let's create a teacher user first.
        ...
        const teacher = await prisma.user.upsert({
            ...
            create: {
                ...
                name: 'Demo Teacher',
                role: 'TEACHER' // Assuming role enum exists
            }
        });
